-- Manual Storage Setup for Portfolio Images
-- Run this in your Supabase Dashboard > SQL Editor

-- 1. First, create the bucket if it doesn't exist (you can also do this via the Storage UI)
...
-- 6. Create trigger to auto-create directories
...
-- 8. Test the setup - this should work without errors if everything is configured correctly
