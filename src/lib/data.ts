...
export const projects: Project[] = [
  {
    ...
    description:
      "A beautiful mid-century dresser restored to its original glory with careful attention to detail.",
  ...
  },
  {
    ...
    description:
      "This cabinet was transformed with a fresh coat of paint and new hardware for a modern look.",
    category: "Modern",
  ...
  },
  {
    ...
    description:
      "A plain bookcase reimagined with custom painting techniques and decorative elements.",
