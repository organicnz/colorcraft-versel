...
export async function sendEmail(options: {
  ...
  try {
    ...
    // Hard-code the from address to ensure it uses our verified domain
    // Ignore any passed options.from or env variables
    const from = 'Color & Craft <contact@colorcraft.live>';
