...
import { Mail, Phone, ExternalLink, Linkedin, Instagram, Twitter, Facebook, Star, Sparkles, Users, Heart } from "lucide-react";
        ...
        <div className="flex-1 min-w-0 space-y-4">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            {specialties && specialties.length > 0 && (
              <div className="flex flex-wrap gap-1 flex-1">
                ...
                {specialties.length > 2 && (
                  <Badge variant="outline" className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-xs px-2 py-1">
                    +{specialties.length - 2}
                  </Badge>
                )}
              </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {/* Social Links */}
              {social_links && Object.entries(social_links as SocialLinks).slice(0, 1).map(([platform, url]) => {
                if (!url) return null;
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <GlassPanel className="text-center mb-16 bg-white/40 dark:bg-white/10 backdrop-blur-2xl border-white/60 dark:border-white/30 shadow-2xl">
          <div className="space-y-6 p-8">
            ...
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white sm:text-5xl">
              Meet Our
              <span className="bg-gradient-to-r from-primary-600 via-secondary-600 to-primary-600 bg-clip-text text-transparent"> Craftspeople</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Our passionate team of artisans and designers bring decades of experience 
              to transform your furniture with expert care and creative vision.
            </p>
          </div>
        </GlassPanel>
        ...
        {teamMembers.length > 0 && (
          <div className="text-center mt-16">
            ...
            >
              <Button asChild size="lg" className="bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white px-8 py-4 font-semibold border-0 shadow-none">
