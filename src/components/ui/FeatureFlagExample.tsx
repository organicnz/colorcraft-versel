    ...
    <div className="p-4 border rounded-md space-y-4">
      ...
      <div className="grid gap-2">
        <div className="flex items-center justify-between">
          <span>Dark Mode:</span>
          <span
            className={`px-2 py-1 rounded text-sm ${darkModeEnabled ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`px-2 py-1 rounded text-sm ${enhancedContactEnabled ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
          >
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className={`px-2 py-1 rounded text-sm ${analyticsEnabled ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
          >
