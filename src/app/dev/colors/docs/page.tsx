    ...
    <div className="container max-w-4xl py-10">
      <div className="space-y-8">
        ...
        <section id="introduction" className="space-y-4">
          ...
          <p>
            The Color & Craft color system is defined in{" "}
            <code className="bg-muted px-1 py-0.5 rounded text-sm">src/styles/colors.ts</code>
            and is integrated with Tailwind CSS for easy use throughout the application. The system
            includes:
          </p>
        ...
        <section id="usage-in-tailwind" className="space-y-4">
          ...
          <p>All colors are available as Tailwind classes using the following syntax:</p>
...
<button className="bg-primary hover:bg-primary-600">Hover Effect</button>`}
          ...
          <Alert>
            ...
            <AlertDescription>
              Always use the semantic color names (primary, secondary, accent) rather than specific
              color names to ensure consistency if the color palette changes.
            </AlertDescription>
          </Alert>
        </section>
        ...
        <section id="gradient-examples" className="space-y-4">
          ...
          <p>Predefined gradients can be applied using inline styles:</p>
          <pre className="bg-muted p-4 rounded-md overflow-auto text-sm my-4">
...
<div style={{ background: "linear-gradient(135deg, #D3A273 0%, #C08A5A 100%)" }}>
  Primary gradient background
          ...
          <p>You can also create a utility class in your CSS:</p>
          <pre className="bg-muted p-4 rounded-md overflow-auto text-sm my-4">
            {`/* In your CSS */
.bg-gradient-primary {
...
<div className="bg-gradient-primary">
  Primary gradient background
        ...
        <section id="extending" className="space-y-4">
          ...
          <p>To extend or modify the color system:</p>
          <ol className="list-decimal pl-6 space-y-2">
            <li>
              Edit{" "}
              <code className="bg-muted px-1 py-0.5 rounded text-sm">src/styles/colors.ts</code> to
              add or modify colors.
            </li>
            <li>
              The Tailwind config will automatically include your changes because it imports from
              this file.
            </li>
...
export const colors = {
  ...
  tertiary: {
    ...
    900: '#1A33FF',
        ...
        <section id="dark-mode" className="space-y-4">
          ...
          <p>
            The color system is designed to work with both light and dark modes. When using
  ...
  <button className="bg-primary-500 dark:bg-primary-600 text-white">
    This button uses a darker shade in dark mode
          ...
          <p>
            For components that need special treatment in dark mode, consider using the useTheme
            hook:
          </p>
          <pre className="bg-muted p-4 rounded-md overflow-auto text-sm my-4">
            {`"use client";
    ...
    <div style={{ backgroundColor: bgColor }}>
      Theme-aware component
        ...
        <section id="best-practices" className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Use semantic colors:</strong> Prefer{" "}
              <code className="bg-muted px-1 py-0.5 rounded text-sm">text-primary-600</code> over
              hardcoded values like{" "}
              <code className="bg-muted px-1 py-0.5 rounded text-sm">text-[#C08A5A]</code>.
            </li>
            <li>
              <strong>Follow color purpose:</strong> Use primary colors for main actions, secondary
              for supporting elements, accent for highlights.
            </li>
            <li>
              <strong>Maintain contrast:</strong> Ensure sufficient contrast between text and
              background colors for accessibility.
            </li>
            <li>
              <strong>Use shades consistently:</strong> Lighter shades (50-200) work well for
              backgrounds, medium shades (400-600) for UI elements, and darker shades (700-900) for
              text.
            </li>
            <li>
              <strong>Status colors:</strong> Use success, warning, and danger colors only for their
              intended purpose to maintain clear user feedback.
            </li>
          </ul>
        </section>
        ...
        <section id="component-examples" className="space-y-4">
          ...
          <p>
            Check out the{" "}
            <Link href="/dev/components" className="text-primary hover:underline">
              Component Showcase
            </Link>{" "}
            to see how the color system is applied to various UI components.
          </p>
        </section>
      </div>
    </div>
