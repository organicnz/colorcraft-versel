...
export default function ImageTestPage() {
  const testImageUrl = "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop&auto=format&q=80";
          ...
          <div className="w-80 h-96 flex flex-col">
            <div className="relative overflow-hidden rounded-3xl bg-white shadow-lg h-full flex flex-col">
              ...
              <div className="relative h-48 overflow-hidden flex-shrink-0">
                <Image
                  src={sampleProject.image || "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&h=600&fit=crop&auto=format&q=80"}
