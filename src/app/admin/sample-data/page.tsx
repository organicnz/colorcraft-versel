  ...
  async function createSampleData() {
    ...
    try {
      ...
      for (const project of sampleProjects) {
        ...
        if (project.client_testimonial) formData.append('client_testimonial', project.client_testimonial);
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4">
          ...
          <Button 
            ...
            disabled={loading || sampleDataCreated}
          >
                  ...
                  {project.techniques && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      {project.techniques.map((tech: string, i: number) => (
                        <span key={i} className="bg-muted text-muted-foreground px-2 py-1 text-xs rounded">
                          {tech}
                        </span>
                      ))}
                    </div>
