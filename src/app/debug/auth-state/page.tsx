      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          {portfolioError ? (
            ...
            <div className="space-y-2">
              <p><strong>Portfolio Count:</strong> {portfolioData.length}</p>
              <div className="mt-4">
                <h3 className="font-medium mb-2">Sample Projects:</h3>
                <ul className="space-y-1">
                  {portfolioData.map((project) => (
                    <li key={project.id} className="text-sm">
                      {project.title} - Status: {project.status} - Featured: {project.is_featured ? 'Yes' : 'No'}
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <div className="space-x-4">
            ...
            <a href="/portfolio-dash" className="text-blue-600 hover:underline">Portfolio Dashboard</a>
          </div>
        </div>
      </div>
    </div>
