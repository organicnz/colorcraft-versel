        ...
        <div className="bg-white border rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <span
                className={`ml-2 p-2 rounded ${testResults.connection.includes("Success") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
              >
            ...
            <div>
              ...
              <span
                className={`ml-2 p-2 rounded ${testResults.projects.includes("Success") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
              >
            ...
            <div>
              ...
              <span
                className={`ml-2 p-2 rounded ${testResults.portfolio.includes("Success") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
              >
            ...
            <div>
              ...
              <span
                className={`ml-2 p-2 rounded ${testResults.allTables.includes("Found") ? "bg-blue-100 text-blue-800" : "bg-red-100 text-red-800"}`}
              >
