...
const SAMPLE_PROJECTS = [
  ...
  },
  {
    ...
    description:
      "This antique Victorian bookcase had beautiful detailing but was suffering from decades of neglect. We carefully repaired the damaged veneer, strengthened loose joints, and matched the original finish using traditional shellac. The brass hardware was cleaned and polished to restore its original luster.",
    before_images: [
      "https://images.unsplash.com/photo-1519710164239-da123dc03ef4?q=80&w=2787&auto=format&fit=crop",
    ],
    after_images: [
      "https://images.unsplash.com/photo-1594026786633-cb924420607d?q=80&w=2070&auto=format&fit=crop",
    ],
  ...
  },
  {
    ...
    brief_description:
      "Creating a sleek, modern coffee table with concrete top and black metal base.",
    description:
      "This contemporary coffee table combines industrial materials with clean lines. We cast a lightweight concrete top with a subtle aggregate pattern and sealed it with a durable matte finish. The custom metal base was fabricated from steel tubing and powder-coated in matte black for durability and style.",
    before_images: [
      "https://images.unsplash.com/photo-1600967082821-f8b36a2f3e25?q=80&w=2070&auto=format&fit=crop",
    ],
    after_images: [
  ...
  },
  {
    ...
    brief_description:
      "Transforming a dated 1980s sideboard into a coastal-inspired statement piece.",
    description:
      "This once-boring 1980s sideboard was transformed into a coastal-inspired statement piece. We updated the silhouette by removing the dated trim and adding simple, clean lines. The piece was painted in a custom-mixed blue-green that evokes ocean waves, with the interior painted in a contrasting warm white. New brass hardware adds a touch of elegance.",
    before_images: [
