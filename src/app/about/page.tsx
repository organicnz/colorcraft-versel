...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-20 md:py-28 bg-slate-50 dark:bg-slate-900 overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="max-w-2xl"
            >
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-light text-slate-800 dark:text-white leading-tight mb-6">
                About <span className="font-medium text-primary">Our Story</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 mb-6 font-light">
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-slate-800">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-light mb-6 leading-tight text-slate-800 dark:text-white">Our <span className="font-medium text-primary">Mission</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-4 text-slate-800 dark:text-white">Quality Craftsmanship</h3>
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-4 text-slate-800 dark:text-white">Sustainable Practices</h3>
              <p className="text-slate-600 dark:text-slate-300 font-light">
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-4 text-slate-800 dark:text-white">Customer Focused</h3>
              <p className="text-slate-600 dark:text-slate-300 font-light">
      ...
      <section className="py-16 md:py-24 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-light mb-6 leading-tight text-slate-800 dark:text-white">Meet <span className="font-medium text-primary">Our Team</span></h2>
            <div className="w-20 h-[2px] bg-primary/50 mx-auto mb-8"></div>
          ...
          >
            {teamMembers.map((member) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-medium text-slate-800 dark:text-white">{member.name}</h3>
                  <p className="text-primary text-sm font-medium mb-4">{member.role}</p>
                  <p className="text-slate-600 dark:text-slate-300 mb-5">{member.bio}</p>
                  
                  <div className="flex space-x-4">
                    {member.social.linkedin && (
                      <Link href={member.social.linkedin} className="text-slate-400 hover:text-primary transition-colors">
                    ...
                    {member.social.instagram && (
                      <Link href={member.social.instagram} className="text-slate-400 hover:text-primary transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    {member.social.pinterest && (
                      <Link href={member.social.pinterest} className="text-slate-400 hover:text-primary transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
