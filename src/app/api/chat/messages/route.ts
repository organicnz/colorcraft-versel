...
export async function GET(request: NextRequest) {
  try {
    ...
    console.warn("🔍 Fetching messages for conversation:", conversationId);
    ...
    console.warn("✅ Messages fetched:", messages?.length || 0);
...
export async function POST(request: NextRequest) {
  try {
    console.warn("🚀 Creating new message...");
    ...
    console.warn("📝 Message data:", body);
    ...
    // Create message
    console.warn("🔄 Inserting message into database...");
    ...
    console.warn("✅ Message created:", message.id);
    ...
    console.warn("🎉 Message successfully created!");
